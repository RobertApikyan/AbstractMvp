![N|Solid](https://github.com/RobertApikyan/AbstractMvp/blob/develop/master/intro/cover.png?raw=true)
...
```groovy
dependencies {
    implementation 'com.github.RobertApikyan:AbstractMvp:1.0.0'
}
```
### Maven
```xml
